...
import { ArrowDownRight, ArrowUpRight, Box, Check, ChevronRight, Code2, Database, Layers3, Menu, Moon, Sun, X, ServerCog } from 'lucide-react'
...
const competencies = [
  ...
  { id: 'tools', icon: Code2, items: ['Git / Version Control', 'VS Code', 'IntelliJ', 'Postman'] },
]
